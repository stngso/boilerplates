@servers(['web' => 'deployer@cerdas.perhutani.co.id -p2212'])

@setup
    $repository = 'git@gitlab.com:kantor-pusat/pht-portal-km-web.git';
    $releases_dir = '/home/deployer/prod/cerdas.perhutani.co.id/web/releases';
    $app_dir = '/home/deployer/prod/cerdas.perhutani.co.id/web';
    $current_dir = '/home/deployer/prod/cerdas.perhutani.co.id/web/current';
    $release = date('YmdHis');
...
@task('backup')
    rm -rf /home/deployer/prod/cerdas.perhutani.co.id/web/backups/codebase/*
    mv {{ $releases_dir }}/* /home/deployer/prod/cerdas.perhutani.co.id/web/backups/codebase
@endtask
